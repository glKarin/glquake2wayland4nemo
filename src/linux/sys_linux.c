...
void Sys_Quit (void)
{
	...
	int c2;
 	archivo2 = fopen("/home/nemo/int_kb_layout","r");
	do { c2 = fscanf(archivo2, "%s", caracteres2); }
	while (c2 != EOF); 
	fclose(archivo2);
	if (caracteres2!="us") system("/usr/bin/gconftool-2 -s /apps/osso/inputmethod/int_kb_layout $(cat /home/nemo/int_kb_layout) -t string");
...
int main (int argc, char **argv)
{
	...
	system("/usr/bin/gconftool-2 -g /apps/osso/inputmethod/int_kb_layout > /home/nemo/int_kb_layout");
 	FILE *archivo;
	char caracteres[100];
	int c;
 	archivo = fopen("/home/nemo/int_kb_layout","r");
