...
#ifdef _HARMATTAN
	ri.Con_Printf( PRINT_ALL, "[karin]: Init SDL virtual buttons layer......" );
	karinNewSDLVKB(0, 0, 1, HARMATTAN_WIDTH, HARMATTAN_HEIGHT);
...
#ifdef _HARMATTAN
	ri.Con_Printf( PRINT_ALL, "[karin]: Destroy SDL virtual buttons layer......" );
	karinDeleteSDLVKB();
	ri.Con_Printf( PRINT_ALL, "Done\n" );
#endif
...
#ifdef _HARMATTAN
	re.KarinNewVKB = karinNewSDLVKB;
	re.KarinDeleteVKB = karinDeleteSDLVKB;
	re.KarinRenderVKB = karinRenderSDLVKB;
