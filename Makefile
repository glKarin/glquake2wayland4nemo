...
BUILD_SDL=NO #YES		# SDL software driver. Works fine for some people.
...
BASE_CFLAGS=-Wall -pipe -Dstricmp=strcasecmp -D_HARMATTAN -D_HARMATTAN_MULTITOUCH \
						...
						-D_HARMATTAN_APPNAME='\"Quake 2 Harmattan and Sailfish\"' \
						-D_HARMATTAN_DEV='\"karin\"' \
						-D_HARMATTAN_DEVCODE='\"Natasha\"' \
						-D_HARMATTAN_DESC='\"Quake 2 + Touch for OpenGLES 1.1 on MeeGo Harmattan and Sailfish\"' \
						-D_HARMATTAN_RELEASE='\"20150824\"' \
						-D_HARMATTAN_RESC='\"/usr/share/quake2/resc/\"' \
						-D_HARMATTAN_SAILFISH
ifeq ($(HAVE_IPV6),YES)
...
GLXLDFLAGS=-L/usr/X11R6/lib$(_LIB) `pkg-config --cflags --libs wayland-client wayland-egl` -lEGL # -lX11 -lXext # -lXxf86dga -lXxf86vm
...
REF_GLX_OBJS = \
	...
	$(BUILDDIR)/karin/wayland_gl_egl1.o \
	$(BUILDDIR)/karin/fbo.o \
...
$(BUILDDIR)/karin/wayland_gl_egl1.o :         $(KARIN_DIR)/wayland_gl_egl1.c $(KARIN_DIR)/gl_egl.c $(KARIN_DIR)/gl_egl.h $(KARIN_DIR)/win_general.c  
	$(DO_GL_SHLIB_CC) $(GLXCFLAGS)
...
$(BUILDDIR)/karin/gl_vkb1.o :         $(KARIN_DIR)/gl_vkb1.c $(KARIN_DIR)/gl_vkb.h 
	$(DO_GL_SHLIB_CC)

$(BUILDDIR)/karin/fbo.o :         $(KARIN_DIR)/fbo.c $(KARIN_DIR)/fbo.h  
	$(DO_GL_SHLIB_CC)
