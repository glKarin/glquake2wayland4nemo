...
# binary
install -D -m 755 release%get_arch/sdlquake2 $RPM_BUILD_ROOT/usr/bin/quake2
# lib
...
%changelog
* Mon Nov 19 2018 Karin Zhao <beyondk2000@gmail.com> - 0.3.3harmattan2
	* rpm: fix packaging non-armv7hl builds by beidl
	* Building sdlquake2 for sound.
	* Add cvar named "harm_swipesens" for setting swipe sensitivity, float number.
	* Some fix.

* Sun Nov 11 2018 Karin Zhao <beyondk2000@gmail.com> - 0.3.3harmattan1
